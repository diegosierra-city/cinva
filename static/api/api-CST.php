...
$db_user = "cityciud_utest";
$db_pass = "o?amSK^kI8GE"; //R6!D[d$0RoDf
$db_name = "cityciud_test";
...
/// FIN metodo GET  ******************
  ...
  if ($ref == 'test') {
    ...
    $myArray = array();
    $result = $mysqli->query("SELECT * FROM cst_tecnicos WHERE email='$email' AND clave='$password2' AND activo='1' LIMIT 1") or die($mysqli->error);
